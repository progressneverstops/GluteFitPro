        ...
        <div className={isDarkMode ? 'dark-mode' : ''}>
            ...
            <main className="main-content">
                <section className="section onboarding-form">
                    <h2 style={{ color: 'var(--primary-color)', textAlign: 'center' }}>Your Personalized Plan... </h2>
                    <h3 style={{ color: 'var(--primary-color)', textAlign: 'center' }}> couple of clicks away</h3>
                    <p style={{ marginBottom: '2rem', textAlign: 'center', fontSize: '1.1rem', color: '#555' }}>Just answer a few questions and input your goals to generate your glute-focused workout and meal plan:</p>
