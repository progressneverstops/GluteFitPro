...
const WorkoutPlans: React.FC = () => {
    ...
    const handleCreatePlan = async () => {
        try {
            const response: AxiosResponse = await axios.post('/api/generateWorkoutPlan', {
                fitnessLevel,
                primaryGoal,
                dietType,
                goalReason,
    ...
    }, [fitnessLevel, primaryGoal, goalReason, dietType, dietPreference, mobilityIssues]);
        ...
        <div className={isDarkMode ? 'dark-mode' : ''}>
            ...
            <main className="main-content">
                <section className="section onboarding-form">
                    ...
                    <p style={{ marginBottom: '2rem', textAlign: 'center', fontSize: '1.1rem', color: '#555' }}>Answer a few questions to generate your glute-focused workout and meal plan:</p>
                </section>
                <section className="section workout-plans-section">
                    ...
                    <div className="form-group submit-group">
                        <button id="createPlanBtn" className="btn-primary" onClick={handleCreatePlan}>Create My Plan</button>
                    </div>
